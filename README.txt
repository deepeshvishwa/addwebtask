...
---------------------
When logged in as the administrator, the "Site Information" form can be found
at the path /admin/config/system/site-information.
...
* This module also provides a URL that responds with a JSON representation of a
  ...
  Key and a node id (nid) of an appropriate node are present, otherwise, it
...
Reference
---------------------
1. Module generated by drush.
2. Check and Passed by Codesniffer
3. Time :- 5.5 hours for development.
